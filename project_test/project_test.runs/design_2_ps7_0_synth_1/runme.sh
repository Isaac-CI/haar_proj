...
HD_PWD='/home/aanout/Documents/mestrado/project_test/project_test/project_test.runs/design_2_ps7_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_ps7_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_ps7_0.tcl
