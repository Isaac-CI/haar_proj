...
-- Date        : Sun Jul  6 23:22:05 2025
-- Host        : ANV-15 running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -force -mode synth_stub
--               /home/aanout/Documents/mestrado/project_test/project_test/project_test.gen/sources_1/bd/design_2/ip/design_2_detectFaces_0_0/design_2_detectFaces_0_0_stub.vhdl
-- Design      : design_2_detectFaces_0_0
...
entity design_2_detectFaces_0_0 is
  Port ( 
  ...
  attribute CHECK_LICENSE_TYPE of design_2_detectFaces_0_0 : entity is "design_2_detectFaces_0_0,detectFaces,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of design_2_detectFaces_0_0 : entity is "design_2_detectFaces_0_0,detectFaces,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=detectFaces,x_ipVersion=1.0,x_ipCoreRevision=2114159834,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_2_detectFaces_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_2_detectFaces_0_0 : entity is "HLS";
  attribute hls_module : string;
  attribute hls_module of design_2_detectFaces_0_0 : entity is "yes";
end design_2_detectFaces_0_0;

architecture stub of design_2_detectFaces_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of ap_clk : signal is "XIL_INTERFACENAME ap_clk, ASSOCIATED_RESET ap_rst, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_2_ps7_0_FCLK_CLK0, INSERT_VIP 0";
