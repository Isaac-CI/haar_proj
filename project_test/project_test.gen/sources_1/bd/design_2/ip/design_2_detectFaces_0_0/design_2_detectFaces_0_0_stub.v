...
//               /home/aanout/Documents/mestrado/project_test/project_test/project_test.gen/sources_1/bd/design_2/ip/design_2_detectFaces_0_0/design_2_detectFaces_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_2_detectFaces_0_0,detectFaces,{}" *) (* CORE_GENERATION_INFO = "design_2_detectFaces_0_0,detectFaces,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=detectFaces,x_ipVersion=1.0,x_ipCoreRevision=2114159834,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "detectFaces,Vivado 2024.2" *) (* hls_module = "yes" *) 
module design_2_detectFaces_0_0(inData_ce0, result_x_ce0, result_x_we0, 
...
/* synthesis syn_force_seq_prim="ap_clk" */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 ap_clk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME ap_clk, ASSOCIATED_RESET ap_rst, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_2_ps7_0_FCLK_CLK0, INSERT_VIP 0" *) input ap_clk /* synthesis syn_isclock = 1 */;
