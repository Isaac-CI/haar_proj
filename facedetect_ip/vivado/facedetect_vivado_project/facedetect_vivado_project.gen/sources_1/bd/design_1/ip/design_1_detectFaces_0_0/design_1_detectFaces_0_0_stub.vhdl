...
-- Date        : Sun Jul  6 04:28:08 2025
-- Host        : ANV-15 running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -force -mode synth_stub -rename_top design_1_detectFaces_0_0 -prefix
--               design_1_detectFaces_0_0_ detectFaces_0_stub.vhdl
...
entity design_1_detectFaces_0_0 is
  Port ( 
  ...
  attribute CHECK_LICENSE_TYPE of design_1_detectFaces_0_0 : entity is "detectFaces_0,detectFaces,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of design_1_detectFaces_0_0 : entity is "detectFaces_0,detectFaces,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=detectFaces,x_ipVersion=1.0,x_ipCoreRevision=2114158675,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_detectFaces_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_1_detectFaces_0_0 : entity is "HLS";
  attribute hls_module : string;
  attribute hls_module of design_1_detectFaces_0_0 : entity is "yes";
end design_1_detectFaces_0_0;

architecture stub of design_1_detectFaces_0_0 is
