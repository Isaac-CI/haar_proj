...
# set_property PACKAGE_PIN BA0 [get_ports {DDR_ba[0]}];
# set_property PACKAGE_PIN BA1 [get_ports {DDR_ba[1]}];
# set_property PACKAGE_PIN BA2 [get_ports {DDR_ba[2]}];

# set_property PACKAGE_PIN A0 [get_ports {DDR_addr[0]}];
# set_property PACKAGE_PIN A1 [get_ports {DDR_addr[1]}];
# set_property PACKAGE_PIN A2 [get_ports {DDR_addr[2]}];
# set_property PACKAGE_PIN A3 [get_ports {DDR_addr[3]}];
# set_property PACKAGE_PIN A4 [get_ports {DDR_addr[4]}];
# set_property PACKAGE_PIN A5 [get_ports {DDR_addr[5]}];
# set_property PACKAGE_PIN A6 [get_ports {DDR_addr[6]}];
# set_property PACKAGE_PIN A7 [get_ports {DDR_addr[7]}];
# set_property PACKAGE_PIN A8 [get_ports {DDR_addr[8]}];
# set_property PACKAGE_PIN A9 [get_ports {DDR_addr[9]}];
# set_property PACKAGE_PIN A10 [get_ports {DDR_addr[10]}];
# set_property PACKAGE_PIN A11 [get_ports {DDR_addr[11]}];
# set_property PACKAGE_PIN A12 [get_ports {DDR_addr[12]}];
# set_property PACKAGE_PIN A13 [get_ports {DDR_addr[13]}];
# set_property PACKAGE_PIN A14 [get_ports {DDR_addr[14]}];
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {start_i}];  # "SW0"
