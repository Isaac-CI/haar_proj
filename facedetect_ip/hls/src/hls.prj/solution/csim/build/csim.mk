...
HLS_SOURCES = ../../../../image.cpp ../../../../main.cpp ../../../../haar.cpp
...
$(ObjDir)/image.o: ../../../../image.cpp $(ObjDir)/.dir csim.mk
...
$(ObjDir)/haar.o: ../../../../haar.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../haar.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
